...
int	main()
{
	...
	i = printf("me: %-10.5o %c\n", 2500, '.');
	printf("%d\n", i);
	i = ft_printf("pf: %-10.5o %c\n", 2500, '.');
	printf("%d\n", i);
	pf_putchar('\n');
	printf("pf minus zero 5: %-05o\n", 2500);
	ft_printf("me minus zero 5: %-05o\n", 2500);
	pf_putchar('\n');
	printf("pf minus 5 precision 10: %-5.10o\n", 2500);
  	ft_printf("me minus 5 precision 10: %-5.10o\n", 2500);
	pf_putchar('\n');
	printf("pf minus zero 5: %-05o\n", 2500);
	ft_printf("me minus zero 5: %-05o\n", 2500);
	pf_putchar('\n');
	...
	printf("%d\n", i);
	pf_putchar('\n');     
	i = printf("pf: %5.o %5.0o\n", 0, 0);
	printf("%d\n", i);
  	i = ft_printf("me: %5.o %5.0o\n", 0, 0);
	printf("%d\n", i);
	pf_putchar('\n');     
	i = printf("pf: %#.o %#.0o\n", 0, 0);
  	printf("%d\n", i);
